                ...
                try:
                    ...
                    for i in range(len(latest_video)):
                        ...
                        if (latest_video[i].vid_info.get('playabilityStatus', {}).get('status') != 'UNPLAYABLE' and
                            ...
                            latest_id_and_name = (latest_video[i].video_id + " | " + latest_video_name[:15])
                            ...
                            latest_date_formated = (
                                    ...
                                    + combined_settings + " (" + str(len(latest_video)).rjust(5)[:5] + ") " + print_colored_text(latest_date, BCOLORS.BLACK)
