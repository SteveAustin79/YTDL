...
while True:
    try:
        ...
        if count_this_run == 0:
            ...
            done_string = f"\n\nDONE! Videos: {count_ok_videos}, Downloaded in this session: {count_this_run} (restricted: {len(video_list_restricted)} / ignored: {len(video_watch_urls)-count_ok_videos})\n"
